...
export function ThemeToggle({
  ...
  return (
    <button
      type="button"
      onClick={toggleTheme}
      className={`theme-toggle inline-flex h-9 min-w-[2.25rem] shrink-0 items-center justify-center rounded-md border-0 px-2 text-[var(--text-heading)] transition hover:text-[var(--accent)] ${surfaceClass} ${className}`}
