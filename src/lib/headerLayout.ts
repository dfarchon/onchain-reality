/**
 * Horizontal bounds of the main site header nav (`Header.tsx` → `.site-header-nav`).
 * Use for full-bleed overlays (e.g. blog post panel) so edges align with “Onchain Reality” / nav row.
 */
