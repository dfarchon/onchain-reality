...
export function Home() {
  ...
  return (
    <>
      <StarryBackground />
      <div className="relative z-[2] mx-auto flex h-[calc(100vh-8rem)] w-full max-w-5xl -translate-y-8 flex-col items-center justify-center px-6 py-16 md:-translate-y-10">
        <div className="retro-box w-full max-w-4xl flex flex-col items-stretch justify-center pb-12 pt-14 text-center md:pt-16">
